...
Public Class Login
    ...
    Private Sub Login_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        infoReader = My.Computer.FileSystem.GetFileInfo("UpAcervo.exe")
        lblDataModificacao.Text = "Data Modificação: " & infoReader.LastWriteTime
        ...
        Try
            ...
            For Each Dr In ds.Tables("Bd").Rows
                ...
                LocalNomeNFeDB = Dr.Item("BDnfe")
                'LocalExeNFe = Dr.Item("LocalNFeExecutavel")
            Next
    ...
    Public Sub ParametrosEmpresa()
        ...
        Try
            ...
            If DR.HasRows = True Then
                ...
                Var_ccVendaBrinde = DR.Item("ccVendaBrinde") & ""
                Var_ccVendaInterna = DR.Item("ccVendaInterna") & ""
                ...
                CabecalhoPersonalizado = DR.Item("CabecalhoPersonalizado")
                vContaDepesaImpostoRetido = DR.Item("ContaDepesaImpostoRetido").ToString
                vCentroCustoImpostoRetido = DR.Item("CentroCustoImpostoRetido").ToString
                bImprimePedido = DR.Item("VisualizaPedido")
                bUsaPapelA4Pedido = DR.Item("UsaPapelA4")
                vCodCRT = DR.Item("CodCRT").ToString
                If VAR_ContaCrVenda = "" Then VAR_ContaCrVenda = "000000"

                Usar_OrdemEmbarque = DR.Item("UsarOrdemEntrega") & ""
    ...
    Private Sub Login_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        If e.KeyCode = Keys.F11 Then
            AtLograouroCliente("Clientes")
            AtLograouroCliente("Fornecedor")
        End If
