...
Public Class PedidoAddItemOS
    ...
    Private Sub EditaIten()
        ...
        ErroLivre = "Produto da lista editado com o código: " & Me.CodigoProduto.Text & " "
    ...
    Private Sub btAdItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btAdItem.Click
        ...
        If OperationItens = INS Then
            ...
            Try
                ...
                ErroLivre = "Adicionado um produto com o código: " & Me.CodigoProduto.Text & " "
                GerarLog(Me.Text, AçãoTP.Livre, My.Forms.PedidoOS.PedidoSequencia.Text)
            ...
            Catch ex As Exception
                ...
                '  GerarLog(Me.Text, AçãoTP.Adicionou, Me.CodigoProduto.Text) - retirado pois não passava pelo log
                CNN.Close()
            End Try
        ...
        ElseIf OperationItens = UPD Then
            ...
            Try
                ...
                ErroLivre = "Editado o produto com o código: " & Me.CodigoProduto.Text & " "
                GerarLog(Me.Text, AçãoTP.Livre, My.Forms.PedidoOS.PedidoSequencia.Text)
            ...
            Catch x As Exception
                CNN.Close()
                MsgBox(x.Message)
                'GerarLog(Me.Text, AçãoTP.Editou, Me.CodigoProduto.Text) - retirado pois não passava pelo log
                Exit Sub
            End Try
        End If
...
#End Region
    ...
    Private Sub ValorDesconto_KeyDown(sender As Object, e As KeyEventArgs) Handles ValorDesconto.KeyDown
        If e.KeyCode = Keys.Insert Then
            My.Forms.PedidoVendaSenhaItem.ShowDialog()
        End If
    End Sub
