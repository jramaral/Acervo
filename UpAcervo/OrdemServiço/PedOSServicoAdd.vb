Public Class PedOSServicoAdd
    ...
    Private Sub btnSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSalvar.Click
        ...
        If OperationItens = INS Then
            ...
            Try
                ...
                ErroLivre = "Adicionado uma mão de obra código: " & Me.CodigoServico.Text & " "
        ...
        ElseIf OperationItens = UPD Then
            ...
            Try
                ...
                ErroLivre = "Editado uma mão de obra código: " & Me.CodigoServico.Text & " "
                GerarLog(Me.Text, AçãoTP.Livre, My.Forms.PedidoOS.PedidoSequencia.Text)
    ...
    Private Sub EditaIten()
        ...
        ErroLivre = "Serviço da lista editado"
