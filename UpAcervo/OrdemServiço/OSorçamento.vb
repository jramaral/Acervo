Public Class OSorçamento
    ...
    Private Sub btSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSalvar.Click
        ...
        ElseIf Operation = UPD Then
            ...
            Try
                ...
                ErroLivre = "Orçamento editado e salvo"
                GerarLog(Me.Text, AçãoTP.Livre, Me.CodOrçamento.Text)
    ...
    Private Sub btImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btImprimir.Click
        ...
        If MessageBox.Show("Deseja imprimir o Orçamento agora", "Atenção", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            ...
            RelatorioCarregar = "OsOrcamento.rpt"
            Dim filtro As String = "{Orcamento.Orcamento} =" & CInt(Me.CodOrçamento.Text)
            Dim f As New ClassView.cView
            f.frm(DirRelat & RelatorioCarregar, LocalBD & Nome_BD, SenhaBancoDados, "", filtro)

            ErroLivre = "Gerado impressão do Orçamento"
            GerarLog(Me.Text, AçãoTP.Livre, Me.CodOrçamento.Text)
    ...
    Private Sub ToolStripMenuItem3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripMenuItem3.Click
        ...
        ErroLivre = "Excluiu uma mão de obra do Orçamento"
        GerarLog(Me.Text, AçãoTP.Livre, Me.CodOrçamento.Text)
    ...
    Private Sub ToolStripMenuItem4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripMenuItem4.Click
        ...
        DR = CMD.ExecuteReader
        ErroLivre = "Excluiu um produto do Orçamento"
        GerarLog(Me.Text, AçãoTP.Livre, Me.CodOrçamento.Text)
