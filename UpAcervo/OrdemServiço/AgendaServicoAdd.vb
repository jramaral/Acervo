...
Public Class AgendaServicoAdd
    ...
    Private Sub btSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSalvar.Click
        If Me.AddTodos.Checked = True Then
            SalvarDadosTodos()
            ' My.Forms.MenuGeral.AtualizarAgenda()
        Else
            SalvarDados()
            'My.Forms.MenuGeral.AtualizarAgenda()
        End If
    ...
    Private Sub SalvarDadosTodos()
        ...
        Try
            Dim idTodosRelacionamento As Integer = 0
            For Each itm As Object In Me.Usuario.Items
                ...
                DRnovo("IdLancTodos") = idTodosRelacionamento
                ...
                If idTodosRelacionamento = 0 Then
                    Dim cmd As New OleDb.OleDbCommand("SELECT @@IDENTITY", CNN)
                    idTodosRelacionamento = cmd.ExecuteScalar()
                End If
            Next
    ...
    Private Sub LocalizaDadosCliente()
        ...
        If DR.HasRows Then
            ...
            Me.Cliendereço.Text = DR.Item("Endereço") & ""
            Me.CliNr.Text = DR.Item("Nro") & ""
            Me.Cliendcomplemento.Text = DR.Item("xCpl") & ""
            Me.FoneCliente.Text = DR.Item("Telefone") & ""
            Me.FoneCliente1.Text = DR.Item("Telefone1") & ""
            Me.FoneCliente2.Text = DR.Item("Fax") & ""
            Me.FoneCliente3.Text = DR.Item("Celular") & ""
        End If
    ...
    Private Sub AcharAgendamento(ByVal Var_Id As Integer)
        ...
        Sql = "SELECT AgendaServico.*, Clientes.Endereço, Clientes.Telefone1, Clientes.Telefone, Clientes.Nro, Clientes.xCpl, Clientes.Fax, Clientes.celular FROM AgendaServico INNER JOIN Clientes ON AgendaServico.Cliente = Clientes.Codigo WHERE (((AgendaServico.Id)=" & CInt(Var_Id) & "));"
        Dim DAAgendaServico As New OleDb.OleDbDataAdapter(Sql, CNN)
        DAAgendaServico.Fill(ds, "AgendaServico")
        ...
        Try
            If ds.Tables("AgendaServico").Rows.Count = 1 Then
                ...
                Me.FoneCliente.Text = ds.Tables("AgendaServico").Rows(0)("Telefone") & ""
                ' inclusão 
                Me.FoneCliente1.Text = ds.Tables("AgendaServico").Rows(0)("Telefone1") & ""
                Me.Cliendereço.Text = ds.Tables("AgendaServico").Rows(0)("Endereço") & ""
                Me.CliNr.Text = ds.Tables("AgendaServico").Rows(0)("Nro") & ""
                Me.Cliendcomplemento.Text = ds.Tables("AgendaServico").Rows(0)("xCpl") & ""
                Me.FoneCliente2.Text = ds.Tables("AgendaServico").Rows(0)("Fax") & ""
                Me.FoneCliente3.Text = ds.Tables("AgendaServico").Rows(0)("Celular") & ""
                ' termino 
    ...
    Private Sub btFinalizado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btFinalizado.Click
        ...
        If MessageBox.Show("Deseja finalizar o Agendamento", "Validação de Dados", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
            ...
            Sql = "UPDATE AgendaServico SET AgendaServico.Status = 'FINALIZADO' WHERE (((AgendaServico.Id)=" & Me.Id.Text & "));"
            Dim CMD As New OleDb.OleDbCommand(Sql, CNN)
            CMD.ExecuteNonQuery()

            Sql = "UPDATE AgendaServico SET AgendaServico.Status = 'FINALIZADO' WHERE (((AgendaServico.IdLancTodos)=" & Me.Id.Text & "));"
            CMD.CommandText = Sql
            CMD.ExecuteNonQuery()
