...
Public Class PedidoVendaEditReceber
    ...
    Private Sub btMudarParcela_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btMudarParcela.Click
        ...
        If String.IsNullOrEmpty(txtVencimento.Text) Then
            MessageBox.Show("A data do vencimento não pode ser nulo", "Validação de Dados", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
