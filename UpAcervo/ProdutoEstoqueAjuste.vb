Public Class ProdutoEstoqueAjuste
        ...
        If MsgBox("Deseja realmente atualizar o estoque para as informações digitadas.", 36, "Validação de Dados") = 6 Then
            ...
            Try
                ...
                Catch ex As Exception
                    MessageBox.Show(ex.Message, "Validação de Dados")
                End Try
    ...
    Private Sub AtProduto()
        ...
        For Each DrEstoque In Ds.Tables("EstoqueUP").Rows
            ...
            Dim Cmd As New OleDb.OleDbCommand(String.Format("Update Produtos Set QuantidadeEstoque = @QuantidadeEstoque, EstoqueFiscal = @EstoqueFiscal Where CodigoProduto = {0} AND CONTROLAESTOQUE LIKE 'SIM'", DrEstoque("CodigoProduto").ToString), CNN)

            Cmd.Parameters.Add(New OleDb.OleDbParameter("@QuantidadeEstoque", NzZero(DrEstoque("SomaDeQtd"))))
            Cmd.Parameters.Add(New OleDb.OleDbParameter("@EstoqueFiscal", NzZero(DrEstoque("SomaDeQtdF"))))
