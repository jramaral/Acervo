    ...
    Public Class Produtos
        ...
        Public Sub LocalizaDados()
            ...
            If DR.HasRows Then
                ...
                Me.cboOrigem.Text = DR.Item("Origem") & ""
        ...
        Private Sub SalvarBT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SalvarBT.Click
            ...
            If Operation = INS Then
                ...
                cmd.Parameters.Add(New OleDb.OleDbParameter("@Origem", Nz(cboOrigem.Text,1)))
            ...
            ElseIf Operation = UPD Then
                ...
                Dim Sql As String = "UPDATE Produtos SET  Descri��o=@1, Tipo=@2, ControlaEstoque=@3, CodigoBarra=@4, UnidadeMedida=@5, C�digoGrupo=@6, Marca=@7, ValorCompra=@8, ValorVenda=@9, Peso=@10, " _
                                    ...
                                    & "ComissaoVenda=@21, Multiplos=@22, EstoqueMinimo=@23, MostrarListaPreco=@24, Atualizado=@25, ValorVenda1=@26, ValorVenda2=@27,  ProdutoNaPromocao=@ProdutoNaPromocao, DataInicioPromocao=@DataInicioPromocao, DataFinalPromocao=@DataFinalPromocao, ValorPromocao=@ValorPromocao,Origem=@Origem Where CodigoProduto = " & Me.CodigoProduto.Text
                Dim cmd As New OleDb.OleDbCommand(Sql, CNN)
...
#End Region
        ...
        Private Sub btnOrigem_Click(sender As Object, e As EventArgs) Handles btnOrigem.Click
            ...
            My.Forms.ProdutosPorOrigem.ShowDialog()
        End Sub
    End Class
End NameSpace