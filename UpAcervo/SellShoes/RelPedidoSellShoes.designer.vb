...
Partial Public Class RelPedidoSellShoes
    ...
    "0"
        Me.Label23.Text = "NÃO É DOCUMENTO FISCAL - NÃO É VÁLIDO COMO RECIBO E COMO GARANTIA DE MERCADORIA -" & _
    ...
    "n: right; ddo-char-set: 1"
        ...
        Me.Label30.Text = "Obs: O Cliente autoriza a cessão total ou parcial das vendas a prazo. Credito suj" & _
    "eito a análise."
