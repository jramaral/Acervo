...
Public Class SellShoesFinalizar
    ...
    Private Sub SellShoesFinalizar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If My.Forms.SellShoes.PedidoTipo.Text = "VENDA BRINDE" Or My.Forms.SellShoes.PedidoTipo.Text = "DEBITO INTERNO" Then
        Else
    ...
    Private Sub btFinalizarVenda_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btFinalizarVenda.Click
        ...
        If My.Forms.SellShoes.Contrato.Text = "" Then
            If My.Forms.SellShoes.PedidoTipo.Text <> "DEVOLUÇÃO" Then
        ...
        If My.Forms.SellShoes.PedidoTipo.Text = "VENDA BRINDE" Or My.Forms.SellShoes.PedidoTipo.Text = "DEBITO INTERNO" Then
            ...
            If Var_ccVendaBrinde = "" Then
                MessageBox.Show("Favor definir a conta de centro de custo de Venda de Brinde nas configurações da empresa.", "Validação de Dados", MessageBoxButtons.OK, MessageBoxIcon.Error)
            ...
            If Var_ccVendaInterna = "" Then
                MessageBox.Show("Favor definir a conta de centro de custo de Venda Interna nas configurações da empresa.", "Validação de Dados", MessageBoxButtons.OK, MessageBoxIcon.Error)
                If Cnn.State = ConnectionState.Open Then
                    Cnn.Close()
                End If
                Me.Close()
        ...
        Try
            ...
            Dim var_Status As String = String.Empty
            If Usar_OrdemEmbarque = "SIM" Then
                var_Status = "ENTREGA"
            Else
                var_Status = "FINALIZADO"
            End If
            ...
            Ds.Tables("Venda").Rows(0)("StatusAndamentos") = var_Status
            ...
            'Transforma receber virtual em não virtual
            Sql = "Update Receber Set Virtual = False Where PedidoProdutos = " & My.Forms.SellShoes.Venda.Text
            Dim CmdReceberVirtual As New OleDb.OleDbCommand(Sql, Cnn)
            ' Dim CmdReceberVirtual As OleDb.OleDbCommand = Cnn.CreateCommand
            CmdReceberVirtual.Transaction = Transacao
            CmdReceberVirtual.ExecuteNonQuery()
            ...
            If CDbl(NzZero(Me.ValorAVista.Text)) <> 0 Then
                ...
                Dim x_Tipo As String = String.Empty
                Dim x_ContaBalancete As String = String.Empty
                Dim x_Favorecido As String = String.Empty
                Dim DEv As Boolean = False
                If My.Forms.SellShoes.PedidoTipo.Text = "DEVOLUÇÃO" Then
                    Hist = "DEV. " & My.Forms.SellShoes.Venda.Text
                    x_Tipo = "C"
                    x_ContaBalancete = Me.ContaBalanceteVendaAvista.Text
                    x_Favorecido = My.Forms.SellShoes.xNome.Text
                    DEv = True
                ElseIf My.Forms.SellShoes.PedidoTipo.Text = "VENDA" Then
                    Hist = "RECEB. AVISTA VENDA. " & My.Forms.SellShoes.Venda.Text
                    x_Tipo = "C"
                    x_ContaBalancete = Me.ContaBalanceteVendaAvista.Text
                    x_Favorecido = My.Forms.SellShoes.xNome.Text
                    DEv = False
                ElseIf My.Forms.SellShoes.PedidoTipo.Text = "VENDA BRINDE" Then
                    Hist = "VENDA BRINDE " & My.Forms.SellShoes.Venda.Text
                    x_Tipo = "R"
                    x_ContaBalancete = "000000"
                    x_Favorecido = "VENDA BRINDE " & My.Forms.SellShoes.xNome.Text
                    DEv = False
                ElseIf My.Forms.SellShoes.PedidoTipo.Text = "DEBITO INTERNO" Then
                    Hist = "DEBITO INTERNO " & My.Forms.SellShoes.Venda.Text
                    x_Tipo = "R"
                    x_ContaBalancete = "000000"
                    x_Favorecido = "DEB. INTERNO " & My.Forms.SellShoes.xNome.Text
                    DEv = False
                End If
                ...
                DrNew("TipoLancamento") = x_Tipo
                DrNew("Favorecido") = x_Favorecido
                ...
                DrNew("ContaBalancete") = x_ContaBalancete
                DrNew("Tipo") = "CAIXA"
                ...
                CmdLcto.CommandText = "SELECT @@IDENTITY"
                Dim IdLancBancoCaixa As Integer = CmdLcto.ExecuteScalar.ToString


                If My.Forms.SellShoes.PedidoTipo.Text = "VENDA BRINDE" Then
                    ...
                    CmdConta1.Parameters.Add(New OleDb.OleDbParameter("@2", nzNUL(Var_ccVendaBrinde)))
                    CmdConta1.Parameters.Add(New OleDb.OleDbParameter("@3", nzDAT(DataDia)))
                    CmdConta1.Parameters.Add(New OleDb.OleDbParameter("@4", nzNUM(Me.ValorAVista.Text)))
                    CmdConta1.ExecuteNonQuery()

                End If

                If My.Forms.SellShoes.PedidoTipo.Text = "DEBITO INTERNO" Then
                    ...
                    CmdConta1.CommandText = "INSERT INTO CcLanc (IdCaixaBanco, ContaCC, DataLanc, ValorLanc) VALUES (@1, @2, @3, @4)"
                    CmdConta1.Parameters.Add(New OleDb.OleDbParameter("@1", nzINT(IdLancBancoCaixa)))
                    CmdConta1.Parameters.Add(New OleDb.OleDbParameter("@2", nzNUL(Var_ccVendaInterna)))
                    CmdConta1.Parameters.Add(New OleDb.OleDbParameter("@3", nzDAT(DataDia)))
                    CmdConta1.Parameters.Add(New OleDb.OleDbParameter("@4", nzNUM(Me.ValorAVista.Text)))
                    CmdConta1.ExecuteNonQuery()
                End If
            ...
            If My.Forms.SellShoes.PedidoTipo.Text = "VENDA" Or My.Forms.SellShoes.PedidoTipo.Text = "VENDA BRINDE" Or My.Forms.SellShoes.PedidoTipo.Text = "DEBITO INTERNO" Then
                TpEst = "S"
