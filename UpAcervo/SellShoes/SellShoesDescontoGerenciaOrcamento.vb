Public Class SellShoesDescontoGerenciaOrcamento
    ...
    Private Sub btConfirmar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btConfirmar.Click
        ...
        'If My.Forms.SellShoes.Visible = True Then My.Forms.SellShoes.SenhaGerencia.Text = Me.Senha.Text & ""
        'If My.Forms.SellShoesOrcamento.Visible = True Then My.Forms.SellShoesOrcamento.SenhaGerencia.Text = Me.Senha.Text & ""
        Me.Close()
        Me.Dispose()
    End Sub

    Private Sub DescontoIndividual1(ByVal ITEM As Integer)
        ...
        If CDbl(DescG) > CDbl(DescontoGerencia) Then
            ...
            If DR.HasRows Then
                ...
                Dim Ccompra As Double = NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(ITEM)("CustoMercadoriaVendida")) * NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(ITEM)("Qtd"))
                Dim ValorItem As Double = NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(ITEM)("ValorUnitario")) * NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(ITEM)("Qtd"))
                Dim ValorAcre As Double = NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(ITEM)("vAcrecimoVenda"))
                Dim ValorDesc As Double = NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(ITEM)("ValorDesconto"))

                ValorItem += ValorAcre
                ValorItem -= ValorDesc
                Dim VDescEspecial As Double = (CDbl(ValorItem) * CDbl(NzZero(Me.DescontoEspecial.Text))) / 100
                ...
                My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(ITEM).BeginEdit()
                My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(ITEM)("pDescontoEspecial") = NzZero(Me.DescontoEspecial.Text)
                My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(ITEM)("vDescontoEspecial") = NzZero(VDescEspecial)
                My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(ITEM).EndEdit()
    ...
    Private Sub DescontoTodos1()
        ...
        If CDbl(DescG) > CDbl(DescontoGerencia) Then
            ...
            If DR.HasRows Then
                ...
                If My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows.Count > 0 Then
                    Dim drlinha As DataRow
                    For Each drlinha In My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows

                        drlinha.BeginEdit()

                        Dim ValorItem As Double = NzZero(drlinha("ValorUnitario")) * NzZero(drlinha("Qtd"))
                        Dim ValorAcre As Double = NzZero(drlinha("vAcrecimoVenda"))
                        Dim ValorDesc As Double = NzZero(drlinha("ValorDesconto"))
                    ...
                    My.Forms.SellShoesOrcamento.ValorProduto.Text = FormatNumber(NzZero(My.Forms.SellShoes.DsItens.Tables("Itens").Compute("sum(TotalProduto)", "")), 2)
                    My.Forms.SellShoesOrcamento.Acrecimo.Text = FormatNumber(NzZero(My.Forms.SellShoes.DsItens.Tables("Itens").Compute("sum(vAcrecimoVenda)", "")), 2)
                    ...
                    My.Forms.SellShoesOrcamento.TotalDesconto.Text = FormatNumber(NzZero(DescNormal) + NzZero(DescEspecial), 2)

                    My.Forms.SellShoesOrcamento.TotalOrc.Text = FormatNumber(CDbl(NzZero(My.Forms.SellShoes.ValorProduto.Text)) + CDbl(NzZero(My.Forms.SellShoes.Acrecimo.Text)) - CDbl(NzZero(My.Forms.SellShoes.TotalDesconto.Text)), 2)
                    My.Forms.SellShoesOrcamento.Lista.Refresh()
        ...
        Else
            ...
            If My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows.Count > 0 Then
                ...
                My.Forms.SellShoesOrcamento.ValorProduto.Text = FormatNumber(NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Compute("sum(TotalProduto)", "")), 2)
                My.Forms.SellShoesOrcamento.Acrecimo.Text = FormatNumber(NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Compute("sum(vAcrecimoVenda)", "")), 2)

                Dim DescEspecial As Double = NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Compute("sum(vDescontoEspecial)", ""))
                Dim DescNormal As Double = NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Compute("sum(ValorDesconto)", ""))
                My.Forms.SellShoesOrcamento.TotalDesconto.Text = FormatNumber(NzZero(DescNormal) + NzZero(DescEspecial), 2)

                My.Forms.SellShoesOrcamento.TotalOrc.Text = FormatNumber(CDbl(NzZero(My.Forms.SellShoesOrcamento.ValorProduto.Text)) + CDbl(NzZero(My.Forms.SellShoesOrcamento.Acrecimo.Text)) - CDbl(NzZero(My.Forms.SellShoesOrcamento.TotalDesconto.Text)), 2)
                My.Forms.SellShoesOrcamento.Lista.Refresh()
    ...
    Private Sub DescontoIndividual(ByVal ITEM As Integer)
        ...
        If Me.DescontoEspecial.Text = "" Then Exit Sub
        ...
        If CDbl(DescG) > CDbl(DescontoGerencia) Then
            ...
            If DR.HasRows Then
                ...
                Dim ValorAcre As Double = NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(ITEM)("vAcrecimoVenda"))
                Dim ValorDesc As Double = NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(ITEM)("ValorDesconto"))
                Dim DescE As Double = FormatNumber(NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(idITEM)("vDescontoEspecial")), 2)
    ...
    Private Sub DescontoValor_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles DescontoValor.Leave
        ...
        Dim ValorItem As Double = NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(idITEM)("ValorUnitario")) * NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(idITEM)("Qtd"))
        Dim DescE As Double = FormatNumber(NzZero(My.Forms.SellShoesOrcamento.DsItens.Tables("Itens").Rows(idITEM)("vDescontoEspecial")), 2)
    ...
    Private Sub SellShoesDescontoGerenciaOrcamento_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If Individual = True Then
