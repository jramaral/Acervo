Public Class CartaoCreditoMenu
    ...
    Private Sub LocalizaPedido()
        ...
        Sql = "SELECT Receber.Documento, Receber.Vencimento, Receber.ValorDocumento, Receber.Cartao, Receber.DocNSU, Receber.codAutenticacao, Receber.DataAutenticacao from Receber Where PedidoProdutos = " & CInt(Me.pPedido.Text) & " and Receber.Baixado = false and Agrupada = False"
