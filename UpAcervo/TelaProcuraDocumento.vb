...
Public Class TelaProcuraDocumento
    ...
    Private Sub TxtProcura_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtProcura.Leave
        ...
        If Me.PedidoVenda.Checked = True Then CarregaLista(4)
    ...
    Private Sub MostraTodos_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MostraTodos.CheckedChanged
        If Me.MostraTodos.Checked Then CarregaLista(5)
        Me.Lista.Focus()
    End Sub
    ...
    Private Sub CarregaLista(ByVal Opt As Integer)
        ...
        Select Case Opt
            Case 1
                Sql = "SELECT Id, FornecedorDesc, NotaFiscal, ValorPedido, Tipo, DataLançamento, Inativo, Confirmado, Destino, NumeroPedidoVenda FROM CompraCtrlPedido WHERE CompraCtrlPedido.Empresa = " & CodEmpresa & " And Id = " & Me.TxtProcura.Text & " order by  CompraCtrlPedido.Id"
            Case 2
                Sql = "SELECT Id, FornecedorDesc, NotaFiscal, ValorPedido, Tipo, DataLançamento, Inativo, Confirmado, Destino, NumeroPedidoVenda FROM CompraCtrlPedido WHERE CompraCtrlPedido.Empresa = " & CodEmpresa & " And FornecedorDesc Like '%" & Me.TxtProcura.Text & "' & '%' order by CompraCtrlPedido.FornecedorDesc"
            Case 3
                Sql = "SELECT Id, FornecedorDesc, NotaFiscal, ValorPedido, Tipo, Datalançamento, Inativo, Confirmado, Destino, NumeroPedidoVenda FROM CompraCtrlPedido WHERE CompraCtrlPedido.Empresa = " & CodEmpresa & " And NotaFiscal = '" & Me.TxtProcura.Text & "' order by CompraCtrlPedido.NotaFiscal"
            Case 4
                Sql = "SELECT Id, FornecedorDesc, NotaFiscal, ValorPedido, Tipo, Datalançamento, Inativo, Confirmado, Destino, NumeroPedidoVenda FROM CompraCtrlPedido WHERE CompraCtrlPedido.Empresa = " & CodEmpresa & " And NumeroPedidoVenda = " & Me.TxtProcura.Text & " order by CompraCtrlPedido.NotaFiscal"
            Case 5
                Sql = "SELECT Id, FornecedorDesc, NotaFiscal, ValorPedido, Tipo, Datalançamento, Inativo, Confirmado, Destino, NumeroPedidoVenda FROM CompraCtrlPedido WHERE CompraCtrlPedido.Empresa = " & CodEmpresa & " order by CompraCtrlPedido.Id"
        End Select
    ...
    Private Sub DocumentoFornecedor_Click(sender As Object, e As EventArgs) Handles DocumentoFornecedor.Click
        Me.TxtProcura.Focus()
    End Sub

    Private Sub PedidoVenda_CheckedChanged(sender As Object, e As EventArgs) Handles PedidoVenda.CheckedChanged
        Me.TxtProcura.Focus()
    End Sub
End Class