...
Public Class OS
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        CType(Me.SubProduto.Report.DataSource, DataDynamics.ActiveReports.DataSources.OleDBDataSource).SQL = "SELECT ItensPedido.PedidoSequencia, ItensPedido.CodigoProduto, ItensPedido.Qtd, ItensPedido.ValorUnitario, ItensPedido.ValorDesconto, ItensPedido.TotalProduto, Produtos.Descrição, ProdutoLocal.SetorLocalDesc, Produtos.UnidadeMedida,[totalproduto]-[valordesconto] AS tot FROM (ItensPedido INNER JOIN Produtos ON ItensPedido.CodigoProduto = Produtos.CodigoProduto) LEFT JOIN ProdutoLocal ON Produtos.Localização = ProdutoLocal.SetorLocal WHERE ItensPedido.PedidoSequencia=" + Me.txtPedido_PedidoSequencia1.Text
    ...
    Private Sub GroupFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GroupFooter1.Format
        If My.Forms.PedidoOS.Issqn.Text Then
    ...
    Private Sub Objetos()
        ...
        If DR.HasRows Then
            Me.Label28.Text = DR.Item("Cp1") & ""
            Me.Label29.Text = DR.Item("Cp3") & ""
            Me.Label30.Text = DR.Item("Cp2") & ""
        End If
