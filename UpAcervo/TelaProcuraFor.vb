...
Public Class TelaProcuraFor
    ...
    Private Sub BuscarFor(ByVal Opt As String)
        ...
        Select Case Opt
            Case 1
                Sql = "Select Fornecedor.CódigoFornecedor, Fornecedor.RazãoSocial, Fornecedor.NomeFantasia, Fornecedor.CgcCpf from Fornecedor  Where CódigoFornecedor = " & Me.TxtProcura.Text & " and Fornecedor.Inativo = False And Fornecedor.Empresa = " & CodEmpresa
            Case 2
            ...
            Case 5
                Sql = "Select Fornecedor.CódigoFornecedor, Fornecedor.RazãoSocial, Fornecedor.NomeFantasia, Fornecedor.CgcCpf from Fornecedor  Where Fornecedor.Empresa = " & CodEmpresa & " And CgcCpf like '%" & Me.TxtProcura.Text & "%'  and Fornecedor.Inativo = False Order by Fornecedor.RazãoSocial"
            Case 6
                Sql = "Select Fornecedor.CódigoFornecedor, Fornecedor.RazãoSocial, Fornecedor.NomeFantasia, Fornecedor.CgcCpf from Fornecedor  Where Fornecedor.Empresa = " & CodEmpresa & " And CgcCpf like '%" & Me.TxtProcura.Text & "%'  and Fornecedor.Inativo = False Order by Fornecedor.RazãoSocial"
            Case 7
    ...
    Private Sub Lista_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Lista.CellDoubleClick
        ...
        If My.Forms.DocumentoEntrada.Visible = True Then My.Forms.DocumentoEntrada.Fornecedor.Text = vID
