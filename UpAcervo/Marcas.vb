Public Class Marcas
    ...
    Private Sub EditarBT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EditarBT.Click
        If Me.Codigo.Text = "" Then
            MsgBox("Não existe Marca para ser editado.", 64, "Validação de Dados")
            Exit Sub
        End If
        Operation = UPD
    ...
    Private Sub SalvarBT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SalvarBT.Click
        ...
        If Operation = INS Then
            ...
            UltimoReg()
            Dim Sql As String = "INSERT INTO Marcas (Codigo, Marca, Empresa) VALUES (@1, @2, @3)"
            Dim cmd As New OleDb.OleDbCommand(Sql, CNN)

            cmd.Parameters.Add(New OleDb.OleDbParameter("@1", Nz(Me.Codigo.Text, 1)))
            cmd.Parameters.Add(New OleDb.OleDbParameter("@2", Nz(Me.Marca.Text, 1)))
        ...
        ElseIf Operation = UPD Then
            ...
            Dim Sql As String = "Update Marcas set Marca = @2, Empresa = @3 Where Codigo = " & Me.Codigo.Text
            Dim cmd As New OleDb.OleDbCommand(Sql, CNN)
    ...
    Public Sub UltimoReg()
        ...
        With Cmd
            .Connection = Cnn
            .CommandTimeout = 0
            .CommandText = "Select max(Codigo) from Marcas"
...
#Region "Rotina de Procura"
    ...
    Private Sub Buscar(ByVal Opt As Integer)
        ...
        Select Case Opt
            Case 1
                Sql = "Select Marcas.Codigo, Marcas.Marca From Marcas Where Marcas.Empresa = " & CodEmpresa & " And Codigo = " & Me.TxtProcura.Text & " Order by Marcas.Marca"
            Case 2
                Sql = "Select Marcas.Codigo, Marcas.Marca From Marcas Where Marcas.Empresa = " & CodEmpresa & "  And Marcas.Marca like '%" & Me.TxtProcura.Text & "%' Order by Marcas.Marca"
            Case 3
                Sql = "Select Marcas.Codigo, Marcas.Marca From Marcas Where Marcas.Empresa = " & CodEmpresa & " Order by Marcas.Marca"
        End Select
    ...
    Private Sub Lista_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Lista.CellDoubleClick
        ...
        Me.Marca.Text = Me.Lista.CurrentRow.Cells(1).Value & ""
        Me.Codigo.Enabled = False
...
#End Region
    ...
    Private Sub ExcluirBT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ExcluirBT.Click
        ...
        Dim Autorizado As Boolean = PedirPermissao(Me.Text, Me.Codigo.Text)
        ...
        Dim SQL As String = "Select * From Produtos Where Marca = " & Me.Codigo.Text
        Dim Cmd As New OleDb.OleDbCommand(SQL, Cnn)
        ...
        Else
            If MsgBox("Deseja realmente excluir este Item ?", 36, "Validação de Dados") = 6 Then
                SQL = "Delete * From Marcas Where Codigo = " & Me.Codigo.Text
