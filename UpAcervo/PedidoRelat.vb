Public Class PedidoRelat
    ...
    Private Sub A1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles A1.CheckedChanged, A2.CheckedChanged, A3.CheckedChanged, A4.CheckedChanged, A7.CheckedChanged, A6.CheckedChanged, A8.CheckedChanged, A9.CheckedChanged, A10.CheckedChanged, A11.CheckedChanged, A12.CheckedChanged, A15.CheckedChanged
    ...
    Private Sub Visualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Visualizar.Click
        ...
        'Por Vendedor por condição Pgto
        If Me.A14.Checked = True Then
            If Me.DataInicial.Text = "" Then
                MsgBox("O usuário deve informar a data inicial para o relatório.", 64, "Validação de Dados")
                Me.DataInicial.Focus()
            ...
            RelatorioCarregar = "PedidosPorVendedorCondPgto"
            My.Forms.VisualizadorRelatorio.ShowDialog()
        End If
        ...
        'Por Vendedor por condição Pgto Sintético
        If Me.A17.Checked = True Then
            If Me.DataInicial.Text = "" Then
                MsgBox("O usuário deve informar a data inicial para o relatório.", 64, "Validação de Dados")
                Me.DataInicial.Focus()
            ...
            RelatorioCarregar = "PedidosFaturadosVendedorCondpgtoSintetico"
            My.Forms.VisualizadorRelatorio.ShowDialog()
        End If
        ...
        If Me.A15.Checked = True Then
            ...
            RelatorioCarregar = "PedidosFaturadosOrdemPedido"
            My.Forms.VisualizadorRelatorio.ShowDialog()
        End If
        ...
        If Me.A16.Checked = True Then
            ...
            RelatorioCarregar = "PedidosFaturadosTP1"
            My.Forms.VisualizadorRelatorio.ShowDialog()
        End If
