...
Public Class PedidoAddItem
    ...
    Private Sub CodigoProduto_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles CodigoProduto.KeyDown
        If e.KeyCode = Keys.Enter Then
            If Me.CodigoProduto.Text = "" Then
                My.Forms.ProcuraProduto.txtProcura.Focus()
    ...
    Public Sub LocalizaProduto()
        ...
        If DR.HasRows = True Then
            ...
            If Me.ValorUnitario.Text = "" Then Me.ValorUnitario.Text = NzZero(DR.Item("ValorVenda"))
            If My.Forms.PedidoVenda.tpComercio.Text = "ATACADO" Then
            ...
            VlrUnitarioTemp = Me.ValorUnitario.Text

            If Me.CustoMercadoriaVendidaUnitario.Text = "" Or Me.CustoMercadoriaVendidaUnitario.Text = FormatNumber(0, 2) Then Me.CustoMercadoriaVendidaUnitario.Text = NzZero(DR.Item("ValorCompra"))
    ...
    Private Sub btAdItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btAdItem.Click
        ...
        If My.Forms.PedidoVenda.UsarLimite.Checked = True Then
            Dim DiferencaLimite As Double = NzZero(My.Forms.PedidoVenda.SaldoLimiteCredito.Text) - NzZero(My.Forms.PedidoVenda.TotalPedido.Text)
        ...
        If OperationItens = INS Then
            ...
            cmd.Parameters.Add(New OleDb.OleDbParameter("@10", NzVlr(My.Forms.PedidoVenda.PedidoSequencia.Text)))
            cmd.Parameters.Add(New OleDb.OleDbParameter("@11", NzVlr(My.Forms.PedidoVenda.PedidoInterno)))
...
#End Region
    ...
    Private Sub Qtd_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Qtd.Leave
        ...
        If My.Forms.PedidoVenda.TpVenda.Text <> "DEVOLUÇÃO" Then
            If NzZero(Me.Multiplos.Text) <> 0 Then
                If My.Forms.PedidoVenda.tpComercio.Text = "ATACADO" Then
    ...
    Private Sub Desconto_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Desconto.Leave
        ...
        If TipoItem <> 99 Then
            ...
            If My.Forms.PedidoVenda.tpComercio.Text = "VAREJO" Then
    ...
    Private Sub ValorUnitario_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles ValorUnitario.Validated
        ...
        If CDbl(Me.ValorUnitario.Text) < CDbl(VlrUnitarioTemp) Then
            MessageBox.Show("O usuário não pode informar o valor menor que do cadastro, o sistema ira voltar o valor", "Validação de Dados", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.ValorUnitario.Text = FormatNumber(NzZero(VlrUnitarioTemp), 2)
            Exit Sub
        End If
