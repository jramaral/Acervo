...
Namespace MenuGeral
    ...
    Public Class MenuGeral
        ...
        Public Sub AtualizaGridDia()
            ...
            Try
                If dgvDom.RowCount > 0 Then  dgvDom.CurrentCell.Selected = False
            Catch ex As Exception
            End Try
            Try
                If dgvSeg.RowCount > 0 Then dgvSeg.CurrentCell.Selected = False
            Catch ex As Exception
            End Try
            Try
                If dgvTer.RowCount > 0 Then dgvTer.CurrentCell.Selected = False
            Catch ex As Exception
            End Try
            Try
                If dgvQua.RowCount > 0 Then dgvQua.CurrentCell.Selected = False
            Catch ex As Exception
            End Try
            Try
                If dgvQui.RowCount > 0 Then dgvQui.CurrentCell.Selected = False
            Catch ex As Exception
            End Try
            Try
                If dgvSex.RowCount > 0 Then dgvSex.CurrentCell.Selected = False
            Catch ex As Exception
            End Try
            Try
                If dgvSab.RowCount > 0 Then dgvSab.CurrentCell.Selected = False
            Catch ex As Exception
            End Try
        End Sub
        ...
        Private Sub Hist�ricosDeDocumentosToolStripMenuItem_Click(sender As Object, e As EventArgs)
        ...
        Private Sub GerarC�digoDeSeguran�aDoDiaToolStripMenuItem_Click(sender As Object, e As EventArgs)
...
#End Region
        ...
        Private Sub ContratosToolStripMenuItem_Click(sender As Object, e As EventArgs)
        ...
        Private Sub Ivent�rioToolStripMenuItem_Click(sender As Object, e As EventArgs)
        ...
        Private Sub CadastroDeProdutosToolStripMenuItem_Click(sender As Object, e As EventArgs) _
            ...
            If Ina = True Then
                ...
                Exit Sub
            Else
                Dim f As New Produtos.Produtos()
                My.Forms.Produtos.ShowDialog()
            End If
        End Sub
        ...
        Private Sub btnItem_ConsCliente_Click(sender As Object, e As EventArgs) Handles btnItem_ConsCliente.Click
            TRVDados(UserAtivo, "ClientesProcura")
            If Ina = True Then
                MsgBox("O usu�rio n�o esta autorizado a usar esta op��o do sistema.", 64, "Valida��o de Dados")
                Exit Sub
            Else
        ...
        Private Sub ButtonX2_Click(sender As Object, e As EventArgs) Handles ButtonX2.Click
            TRVDados(UserAtivo, "AddCompromisso")
            If Ina = True Then
                MsgBox("O usu�rio n�o esta autorizado a usar esta op��o do sistema.", 64, "Valida��o de Dados")
                Exit Sub
            Else
        ...
        Private Sub Loca��oToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles Loca��oToolStripMenuItem1.Click
            TRVDados(UserAtivo, "LocacaoRelatorios")
            If Ina = True Then
                MsgBox("O usu�rio n�o esta autorizado a usar esta op��o do sistema.", 64, "Valida��o de Dados")
                Exit Sub
            Else
        ...
        Private Sub Loca��oToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles Loca��oToolStripMenuItem.Click

        End Sub

        Private Sub Or�amentoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles Or�amentoToolStripMenuItem.Click
        ...
        End Sub
        Private sub Rolagem(ByRef dgv As DataGridView, ByVal direcao as string)
        ...
        Private Sub dgvSeg_MouseMove(sender As Object, e As MouseEventArgs) Handles dgvSeg.MouseMove, dgvTer.MouseMove, dgvSex.MouseMove, dgvSab.MouseMove, dgvQui.MouseMove, dgvQua.MouseMove, dgvDom.MouseMove
            DesativarTimer(false)
        End Sub

        private sub DesativarTimer(ByVal param As Boolean)
            TimerAgenda.Enabled=param
        End sub

        Private Sub ExpandablePanel1_MouseMove(sender As Object, e As MouseEventArgs) Handles ExpandablePanel1.MouseMove
            DesativarTimer(true)
        End Sub
        ...
        Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
            my.Forms.RelatorioProduto.ShowDialog()
        End Sub

        Private Sub ValorDoEstoqueToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ValorDoEstoqueToolStripMenuItem.Click
            my.Forms.RelatorioProduto.ShowDialog()
        End Sub
    End Class
End NameSpace