Public Class PermissaoAddEdd
    ...
    Private Sub btExcluir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btExcluir.Click
        ...
        Try
            ...
            GerarLog(Me.Text, AçãoTP.Excluiu, Me.Tela.Text)
    ...
    Private Sub Login_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Login.SelectedValueChanged
        AddHandler Login.SelectedValueChanged, AddressOf PegaValorComboUSER
        'Try
        '    AcharLogin(Me.Tela.Text, Me.Login.SelectedValue)
        'Catch ex As Exception
        'End Try
    ...
    Private Sub PegaValorComboUSER(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Me.Login.SelectedIndex <> -1 Then
            AcharLogin(Me.Tela.Text, Me.Login.SelectedValue.ToString)
        End If
    End Sub
