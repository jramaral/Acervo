Public Class ComprasRelat
    ...
    Private Sub A1_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles A1.CheckedChanged, A2.CheckedChanged, A20.CheckedChanged, A21.CheckedChanged, A3.CheckedChanged, A4.CheckedChanged, A5.CheckedChanged, A6.CheckedChanged, A22.CheckedChanged, compraCFOP.CheckedChanged
        ...
        If compraCFOP.Checked = True Then
            Me.PainelPeriodo.Visible = True
            Me.PainelFornecedor.Visible = False
            Me.PainelProdutos.Visible = False
            Me.DataInicial.Focus()
    ...
    Private Sub Visualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Visualizar.Click
        ...
        If Me.A6.Checked = True Then
            ...
            RelatorioCarregar = "RelComprafornecedortipo"
            My.Forms.VisualizadorRelatorio.ShowDialog()
        End If
        ...
        If Me.A22.Checked = True Then
            ...
            RelatorioCarregar = "RelComprasimpostosverifcacaoperiodo"
            My.Forms.VisualizadorRelatorio.ShowDialog()
        End If

        If Me.compraCFOP.Checked = True Then
            If Me.DataInicial.Text = "" Then
                MsgBox("O usuário deve informar a data inicial para o relatório.", 64, "Validação de Dados")
                Me.DataInicial.Focus()
                Exit Sub
            ...
            RelatorioCarregar = "RelComprasCfopPeriodo"
            My.Forms.VisualizadorRelatorio.ShowDialog()
        End If
