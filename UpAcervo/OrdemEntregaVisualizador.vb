Public Class OrdemEntregaVisualizador
    ...
    Private Sub OrdemEmbarqueVisualizador_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If My.Forms.PedidoOS.PedidoSequencia.Text = "" Then
            Exit Sub
        End If
        ...
        With Cmd
            .Connection = Cnn
            .CommandTimeout = 0
            .CommandText = "SELECT OrdemEntrega.*, Clientes.Nome, OrdemEntrega.Pedido FROM Clientes INNER JOIN OrdemEntrega ON Clientes.Codigo = OrdemEntrega.Cliente WHERE OrdemEntrega.Pedido = " & My.Forms.PedidoOS.PedidoSequencia.Text
