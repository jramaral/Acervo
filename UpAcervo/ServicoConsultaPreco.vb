Public Class ServicoConsultaPreco
    ...
    Private Sub ServicoConsultaPreco_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub txtProcura_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtProcura.Leave
        Try
            ...
            If Me.A1.Checked = True Then
                Sql = "SELECT Serv_Codigo,Serv_Descricao,Serv_valorservico,Serv_Referencia FROM Servicos WHERE Serv_Codigo=" & Me.txtProcura.Text & " AND Empresa=" & CodEmpresa
            End If
            If Me.A2.Checked = True Then
                Sql = "SELECT Serv_Codigo,Serv_Descricao,Serv_valorservico,Serv_Referencia FROM Servicos WHERE Serv_Descricao Like '%" & Me.txtProcura.Text & "%' AND Empresa = " & CodEmpresa
            End If
            If Me.A4.Checked = True Then
                Sql = "SELECT Serv_Codigo,Serv_Descricao,Serv_valorservico,Serv_Referencia FROM Servicos WHERE Serv_Referencia Like '%" & Me.txtProcura.Text & "%' AND Empresa = " & CodEmpresa
            End If
    ...
    Private Sub MostraTodos_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles A3.CheckedChanged
        If Me.A3.Checked = True Then
            ...
            Dim sql As String = "SELECT Serv_Codigo,Serv_Descricao,Serv_valorservico,Serv_Referencia FROM Servicos WHERE Empresa=" & CodEmpresa
