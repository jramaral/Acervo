Public Class Cor
    ...
    Private Sub SalvarBT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SalvarBT.Click
        ...
        If Me.Codigo.Text = "" Then
            MsgBox("O Código da Cor não foi informado, favor verificar.", 64, "Validação de Dados")
            Me.Codigo.Focus()
            Exit Sub
        ElseIf Me.CorDesc.Text = "" Then
            MsgBox("A  Descrição da Cor não foi informado, favor verificar.", 64, "Validação de Dados")
            Me.CorDesc.Focus()
            Exit Sub
        End If
