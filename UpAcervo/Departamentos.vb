Public Class Departamentos
    ...
    Private Sub SalvarBT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SalvarBT.Click
        ...
        If Me.Codigo.Text = "" Then
            MsgBox("O Código do Departamento não foi informado, favor verificar.", 64, "Validação de Dados")
            Me.Codigo.Focus()
            Exit Sub
        ElseIf Me.Departamento.Text = "" Then
            MsgBox("A  Descrição do Departamento não foi informado, favor verificar.", 64, "Validação de Dados")
            Me.Departamento.Focus()
            Exit Sub
        End If
    ...
    Private Sub EditarBT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EditarBT.Click
        If Me.Codigo.Text = "" Then
            MsgBox("Não existe Departamento para ser editado.", 64, "Validação de Dados")
            Exit Sub
        End If
        Operation = UPD
        Ação.Desbloquear_Controle(Me, True)
