...
Public Class CentroCustoNewLocalizar
    ...
    Public Sub MostrarTreeGrupo()
        ...
        Select Case Nivel_Var
            Case 1
                sql = "SELECT ContaGrupo1, DescContaGrupo1, Empresa FROM Cc1 WHERE Empresa =  " & CodEmpresa & " ORDER BY ContaGrupo1"
            Case 2
                sql = "SELECT Cc1.ContaGrupo1, Cc1.DescContaGrupo1, Cc2.ContaGrupo2, Cc2.DescContaGrupo2, Cc1.Empresa FROM Cc1 LEFT OUTER JOIN Cc2 ON Cc1.ContaGrupo1 = Cc2.ContaGrupo1 WHERE Cc1.Empresa =  " & CodEmpresa & " ORDER BY Cc1.ContaGrupo1, Cc2.ContaGrupo2"
            Case 3
    ...
    Private Sub treeView1_NodeMouseDoubleClick(sender As Object, e As TreeNodeMouseClickEventArgs) Handles treeView1.NodeMouseDoubleClick
        ...
        If My.Forms.CentroCustoNewRelat.Visible = True Then
            My.Forms.CentroCustoNewRelat.ContaCC.Tag = Var_G1
            My.Forms.CentroCustoNewRelat.ContaCC.Text = strNodeG1
            Me.Close()
            Me.Dispose()
        End If
        ...
        If My.Forms.BalanceteEdit.Visible = True Then
            My.Forms.BalanceteEditLancCC.ContaCC.Text = strNodeG1
            Me.Close()
            Me.Dispose()
        End If
        ...
        If My.Forms.EmpresaConfiguracao.Visible = True Then
            Select Case My.Forms.EmpresaConfiguracao.IdContaLanc
                ...
                Case "IMPOSTORETIDO"
                    My.Forms.EmpresaConfiguracao.CentroCustoImpostoRetido.Text = strNodeG1
                Case "CCVENDABRINDE"
                    My.Forms.EmpresaConfiguracao.ccVendaBrinde.Text = strNodeG1
                Case "CCVENDAINTERNA"
                    My.Forms.EmpresaConfiguracao.ccVendaInterna.Text = strNodeG1
            End Select
            Me.Close()
            Me.Dispose()
        End If
    ...
    Private Sub CentroCustoNewLocalizar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If Nivel_Var = 0 Then Nivel_Var = 3
        pGrupo = 3
        Me.txtPesquisa.Focus()
    End Sub

    Private Sub txtPesquisa_Enter(sender As Object, e As EventArgs)
