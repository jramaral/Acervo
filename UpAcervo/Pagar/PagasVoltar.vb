Public Class PagasVoltar
    ...
    Private Sub btVoltar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btVoltar.Click
        ...
        Try
            ...
            Dim I As Integer = 0
            Dim IdCaixa As Integer
            For I = 0 To Me.ListaCaixa.Items.Count - 1
                IdCaixa = ListaCaixa.Items(I).Text.Substring(0)
                Sql = "Delete FROM CcLanc WHERE IdCaixaBanco = " & IdCaixa
                Cmd.CommandText = Sql
                Cmd.ExecuteNonQuery()
            Next
