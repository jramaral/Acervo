...
Public Class PagarAgrupar
    ...
    Private Sub SalvarCab()
        ...
        If Operation = INS Then
            ...
            Try
                ...
                Dim Sql As String = "INSERT INTO PagarAgrupar (DataLancamento,Descricao,Fornecedor,ValorAgrupado,DiasParcelamento,Confirmado,Empresa,Extornado,Conta1,Vlr1,ContaDespesa) VALUES (@DataLancamento,@Descricao,@Fornecedor,@ValorAgrupado,@DiasParcelamento,@Confirmado,@Empresa,@Extornado,@Conta1,@Vlr1,@ContaDespesa)"
    ...
    Public Sub EncheListaPagar()
        ...
        Dim Sql As String = "SELECT  Id,Documento,ValorDocumento,Vencimento,LocalPgto,CodFornecedor FROM Pagar WHERE Pagar.IdAgrupamento = " & Me.IdAgrupar.Text & " AND Agrupada = False ORDER BY ID"
        ...
        Me.TotParcelado.Text = FormatNumber(NzZero(DsPagar.Tables("Pagar").Compute("sum(ValorDocumento)", "")), 2)
        CNNListaPagar.Close()
    ...
    Private Sub Conta1_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Conta1.Validating
    ...
    Private Sub Vlr1_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Vlr1.Leave
        ...
        If CDbl(NzZero(Me.ValorAgrupado.Text)) < (CDbl(NzZero(Me.Vlr1.Text))) Then
    ...
    Private Sub Vlr1_Enter(sender As Object, e As EventArgs) Handles Vlr1.Enter
        Me.Vlr1.Text = FormatNumber(NzZero(Me.ValorAgrupado.Text), 2)
    End Sub




    Private Sub btSalvarParcelas_Click(sender As Object, e As EventArgs) Handles btSalvarParcelas.Click
        Dim obj As New OleDb.OleDbCommandBuilder(DaPagar)
        DaPagar.Update(DsPagar, "Pagar")

        Me.TotParcelado.Text = FormatNumber(NzZero(DsPagar.Tables("Pagar").Compute("sum(ValorDocumento)", "")), 2)

        If Me.TotParcelado.Text <> Me.ValorAgrupado.Text Then
            MessageBox.Show("Valor Parcelado diferente do total agrupado.", "Validação de Dados", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
