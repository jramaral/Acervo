Public Class CaixaLançamentos
    ...
    Public UltRegDebito As Integer
    ...
    Private Sub BtSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSalvar.Click
        ...
        Try
            ...
            If A2.Checked = True Then
                ...
                If Me.ContaCC.Text <> "" Then
                    If CDbl(ValorLanc) < 0 Then ValorLanc = ValorLanc * -1
            ...
            If Me.A1.Checked = True Then
                ...
                End If
            Else
                If MsgBox("Deseja imprimir o recibo.", 36, "Validação de Dados") = 6 Then
                    'Fazer impressão do recibo
                    RelatorioCarregar = "RelReciboCaixaDebito"
                    My.Forms.VisualizadorRelatorio.ShowDialog()
                End If
            End If
    ...
    Private Sub btnCadastrar_Click(sender As Object, e As EventArgs) Handles btnCadastrar.Click
        ...
        ElseIf checkFornecedor.Checked Then
            My.Forms.Fornecedor.ShowDialog()
        End If
    End Sub

    Private Sub Documento_Enter(sender As Object, e As EventArgs) Handles Documento.Enter
        Documento.Text = Date.Now.Year & "." & Date.Now.Day & Date.Now.Hour & Date.Now.Minute & "-" & Date.Now.Second
    End Sub
End Class