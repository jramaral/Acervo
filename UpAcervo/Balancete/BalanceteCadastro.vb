Public Class BalanceteCadastro
    ...
    Private Sub ExcluirContaToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ExcluirContaToolStripMenuItem.Click
        ...
        If strAr.Length = 1 Then
            Sql = "SELECT Count(BalanceteLanc.Id) AS ContarDeId, BalanceteLanc.ContaBalancete FROM(BalanceteLanc) GROUP BY BalanceteLanc.ContaBalancete HAVING (((BalanceteLanc.ContaBalancete)='" & strAr(0) & "'));"
        ElseIf strAr.Length = 2 Then
            Sql = "SELECT Count(BalanceteLanc.Id) AS ContarDeId, BalanceteLanc.ContaBalancete FROM(BalanceteLanc) GROUP BY BalanceteLanc.ContaBalancete HAVING (((BalanceteLanc.ContaBalancete)='" & strAr(1) & "'));"
        ElseIf strAr.Length = 3 Then
            Sql = "SELECT Count(BalanceteLanc.Id) AS ContarDeId, BalanceteLanc.ContaBalancete FROM(BalanceteLanc) GROUP BY BalanceteLanc.ContaBalancete HAVING (((BalanceteLanc.ContaBalancete)='" & strAr(2) & "'));"
        End If
        ...
        Try
            ...
            If strAr.Length = 1 Then
                Sql = "DELETE FROM ContasG1 WHERE (((ContasG1.ContaGrupo1)='" & strAr(0) & "'))"
            ElseIf strAr.Length = 2 Then
                Sql = "DELETE FROM ContasG2 WHERE (((ContasG2.ContaGrupo2)='" & strAr(1) & "') and ContasG2.ContaGrupo1 = '" & strAr(0) & "')"
            ElseIf strAr.Length = 3 Then
                Sql = "DELETE FROM ContasG3 WHERE (((ContasG3.ContaGrupo3)='" & strAr(2) & "') and ContasG3.ContaGrupo2 = '" & strAr(1) & "' And ContasG3.ContaGrupo1 = '" & strAr(0) & "')"
            End If
