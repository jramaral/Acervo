...
Public Class BalanceteContasProcura
    ...
    Dim Nivel_Var As Integer 'Niveis 1 2 e 3
    ...
    Public Sub MostrarTreeGrupo()
        ...
        Select Case Nivel_Var
            Case 1
                If TipoConta <> "" Then
                    sql = "SELECT ContasG1.ContaGrupo1, ContasG1.DescContaGrupo1, ContasG1.Tipo FROM ContasG1  WHERE ContasG1.Empresa = " & CodEmpresa & " AND ContasG1.Tipo = '" & TipoConta & "' ORDER BY ContasG1.ContaGrupo1"
                Else
                    sql = "SELECT ContasG1.ContaGrupo1, ContasG1.DescContaGrupo1, ContasG1.Tipo FROM ContasG1  WHERE ContasG1.Empresa = " & CodEmpresa & " ORDER BY ContasG1.ContaGrupo1"
                End If
            Case 2
                If TipoConta <> "" Then
                    sql = "SELECT ContasG1.ContaGrupo1, ContasG1.DescContaGrupo1, ContasG2.ContaGrupo2, ContasG2.DescContaGrupo2, ContasG1.Tipo FROM (ContasG1 INNER JOIN ContasG2 ON ContasG1.ContaGrupo1 = ContasG2.ContaGrupo1) WHERE (((ContasG1.Empresa)=" & CodEmpresa & ") AND ((ContasG1.Tipo)='" & TipoConta & "')) ORDER BY ContasG1.ContaGrupo1, ContasG2.ContaGrupo2;"
                Else
                    sql = "SELECT ContasG1.ContaGrupo1, ContasG1.DescContaGrupo1, ContasG2.ContaGrupo2, ContasG2.DescContaGrupo2, ContasG1.Tipo FROM (ContasG1 INNER JOIN ContasG2 ON ContasG1.ContaGrupo1 = ContasG2.ContaGrupo1) WHERE (((ContasG1.Empresa)=" & CodEmpresa & ")) ORDER BY ContasG1.ContaGrupo1, ContasG2.ContaGrupo2"
                End If
            Case 3
                If TipoConta <> "" Then
                    sql = "SELECT ContasG1.ContaGrupo1, ContasG1.DescContaGrupo1, ContasG2.ContaGrupo2, ContasG2.DescContaGrupo2, ContasG3.ContaGrupo3, ContasG3.DescContaGrupo3, ContasG3.TipoLanc,  ContasG1.Tipo FROM (ContasG1 INNER JOIN ContasG2 ON ContasG1.ContaGrupo1 = ContasG2.ContaGrupo1) INNER JOIN ContasG3 ON (ContasG2.ContaGrupo2 = ContasG3.ContaGrupo2) AND (ContasG2.ContaGrupo1 = ContasG3.ContaGrupo1) WHERE (((ContasG3.Empresa)=" & CodEmpresa & ") AND ((ContasG1.Tipo)='" & TipoConta & "')) ORDER BY ContasG1.ContaGrupo1, ContasG2.ContaGrupo2, ContasG3.ContaGrupo3;"
                Else
                    sql = "SELECT ContasG1.ContaGrupo1, ContasG1.DescContaGrupo1, ContasG2.ContaGrupo2, ContasG2.DescContaGrupo2, ContasG3.ContaGrupo3, ContasG3.DescContaGrupo3, ContasG3.TipoLanc,  ContasG1.Tipo FROM (ContasG1 INNER JOIN ContasG2 ON ContasG1.ContaGrupo1 = ContasG2.ContaGrupo1) INNER JOIN ContasG3 ON (ContasG2.ContaGrupo2 = ContasG3.ContaGrupo2) AND (ContasG2.ContaGrupo1 = ContasG3.ContaGrupo1) WHERE (((ContasG3.Empresa)=" & CodEmpresa & ")) ORDER BY ContasG1.ContaGrupo1, ContasG2.ContaGrupo2, ContasG3.ContaGrupo3;"
                End If
        End Select
    ...
    Private Sub treeView1_NodeMouseDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.TreeNodeMouseClickEventArgs) Handles treeView1.NodeMouseDoubleClick
        ...
        Select Case e.Node.Tag
            Case "G1"
                NomeStr = Mid(NameNode, 1, NameNode.IndexOf("/"))
                NomeStr = Mid(NomeStr, 1)
                strNodeG1 = NomeStr
                NodeDescricao = Mid(e.Node.Text, 6)
                If Nivel_Var <> 1 Then Exit Sub
            Case "G2"
                NomeStr = Mid(NameNode, 1, NameNode.IndexOf("/"))
                Var_G1 = Mid(NomeStr, 1, 4)
                NomeStr = Mid(NomeStr, 6)
                strNodeG1 = NomeStr
                NodeDescricao = Mid(e.Node.Text, 6)
                If Nivel_Var <> 2 Then Exit Sub
            Case "G3"
                NomeStr = Mid(NameNode, 1, NameNode.IndexOf("/"))
                NomeStr = Mid(NomeStr, 11)
                strNodeG1 = NomeStr
                NodeDescricao = Mid(e.Node.Text, 8)
                If Nivel_Var <> 3 Then Exit Sub
        End Select
        ...
        If My.Forms.EmpresaConfiguracao.Visible = True Then
            Select Case My.Forms.EmpresaConfiguracao.IdContaLanc
                ...
                Case "IMPOSTORETIDO"
                    My.Forms.EmpresaConfiguracao.ContaDepesaImpostoRetido.Text = strNodeG1
            End Select
            Me.Close()
            Me.Dispose()
        End If

        If My.Forms.BalanceteRelat.Visible = True Then
            My.Forms.BalanceteRelat.ContaBalancete.Tag = Var_G1
            My.Forms.BalanceteRelat.ContaBalancete.Text = strNodeG1
            Me.Close()
            Me.Dispose()
        End If
        ...
        If My.Forms.BalanceteEdit.Visible = True Then
            My.Forms.BalanceteEdit.ContaBalancete.Text = strNodeG1
            Me.Close()
            Me.Dispose()
        End If
    ...
    Private Sub BalanceteContasProcura_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If Nivel_Var = 0 Then Nivel_Var = 3
    End Sub
End Class