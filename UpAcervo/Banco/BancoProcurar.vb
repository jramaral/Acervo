Public Class BancoProcurar
    ...
    Private Sub MyLista_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyLista.DoubleClick
        ...
        If DR.HasRows Then
            ...
            Me.DataConciliacao.Text = DR.Item("DataConciliacao") & ""
    ...
    Private Sub ButtonX1_Click(sender As Object, e As EventArgs) Handles ButtonX1.Click
        Try
            ...
            Autorizado = PedirPermissao(Me.Text, Me.Id.Text)
            ...
            Dim Sql As String = "UPDATE LancamentoBanco SET Documento=" & Me.Documento.Text & " WHERE LancamentoBanco.Id = " & Me.Id.Text

            Dim CMD As New OleDb.OleDbCommand(Sql, Cnn)
            CMD.ExecuteNonQuery()
            MessageBox.Show("Documento alterado com sucesso.", "Validação de Dados", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Me.Close()
            Me.Dispose()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Validação de Dados", MessageBoxButtons.OK, MessageBoxIcon.Information)
