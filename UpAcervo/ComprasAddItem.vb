Public Class ComprasAddItem
    ...
    Public Sub LocalizaProduto()
        ...
        If DR.HasRows Then
            ...
            Me.DescProduto.Text = DR.Item("Descri��o") & ""
    ...
    Private Sub Qtd_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Qtd.Leave
        ...
        Me.Total.Text = FormatCurrency(CDbl(Me.Qtd.Text) * CDbl(Me.ValorUnitario.Text)) '  teste soma
    End Sub
    ...
    Private Sub SalvarItens_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SalvarItens.Click
        If Me.CodigoProduto.Text = "" Then
            MsgBox("N�o foi localizado um produto v�lido", 48, "Validador de Dados")
            Exit Sub
        End If

        If Me.CFOP.Text = "" Then
            MsgBox("N�o foi informado o CFOP do produto.", 48, "Validador de Dados")
            Exit Sub
        End If

        If NzZero(Me.Qtd.Text) = 0 Then
            MessageBox.Show("O usu�rio n�o pode adicionar item com quantidade ZERO, favor verificar.", "Valida��o de Dados", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Qtd.Focus()
            Exit Sub
        End If

        If NzZero(Me.ValorUnitario.Text) = 0 Then
            MessageBox.Show("O usu�rio n�o pode adicionar um item com valor unitario ZERO.", "Valida��o de Dados", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.ValorUnitario.Focus()
            Exit Sub
        End If

        If NzZero(Me.Total.Text) = 0 Then
            MessageBox.Show("O usu�rio n�o pode adicionar um item com valor Total ZERO.", "Valida��o de Dados", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Total.Focus()
            Exit Sub
        End If
        ...
        If Operation = INS Then
            ...
            OutrosIPI = NzZero(Me.ValorOutrosIpi.Text) '
            ...
            Try
                ...
                If v_ValorCompra < CDbl(Me.ValorUnitario.Text) Then
                    If MsgBox("Deseja alterar o custo do produto agora", MsgBoxStyle.Exclamation + MsgBoxStyle.YesNo, "Aten��o") = MsgBoxResult.Yes Then
    ...
    Public Sub LocalizaItens()
        ...
        ' Dim Sql As String = "SELECT ItensCompra.*, Produtos.Descri��o, ItensCompra.Id FROM ItensCompra INNER JOIN Produtos ON ItensCompra.CodigoProduto = Produtos.CodigoProduto WHERE ItensCompra.Id = " & Me.Id.Text
        Dim Sql As String = "SELECT ItensCompra.*, Produtos.Descri��o, CFOP.Descri��o, ItensCompra.Id FROM (ItensCompra INNER JOIN Produtos ON ItensCompra.CodigoProduto = Produtos.CodigoProduto) LEFT JOIN CFOP ON ItensCompra.CFOP = CFOP.CFOP WHERE (((ItensCompra.Id)=" & Me.Id.Text & "));"
        ...
        If DR.HasRows Then
            ...
            Operation = UPD
        Else
            MessageBox.Show("Esta identifica��o do Produto n�o foi encontrada.", "Validador de Dados", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Operation = INS
    ...
    Private Sub AcharCFOP(ByVal CfopValor As String, ByVal CFOPcontrole As Control, ByVal DESCcontrole As Control)
        ...
        If DR.HasRows = True Then
            ...
            DESCcontrole.Text = DR.Item("Descri��o") & ""
        Else
            CFOPcontrole.Text = ""
            DESCcontrole.Text = ""
            CFOPcontrole.Focus()
    ...
    Private Sub Label22_Click(sender As Object, e As EventArgs) Handles Label22.Click
        Me.ValorOutrosIcms.Text = FormatNumber((CDbl(NzZero(Me.Total.Text)) + CDbl(NzZero(Me.ValorFreteProduto.Text)) + CDbl(NzZero(Me.vOutro.Text)) + CDbl(NzZero(Me.vSeg.Text))) - CDbl(NzZero(Me.ValorDesconto.Text)), 3)
    End Sub

    Private Sub ValorUnitario_Leave(sender As Object, e As EventArgs) Handles ValorUnitario.Leave
        Me.Total.Text = FormatCurrency(CDbl(Me.Qtd.Text) * CDbl(Me.ValorUnitario.Text)) '  teste soma
    End Sub
    ...
    Private Sub ValorFreteProduto_Leave(sender As Object, e As EventArgs) Handles ValorFreteProduto.Leave

    End Sub

    Private Sub vSeg_Leave(sender As Object, e As EventArgs) Handles vSeg.Leave

    End Sub

    Private Sub vOutro_Leave(sender As Object, e As EventArgs) Handles vOutro.Leave
        'Me.Total.Text = FormatCurrency(CDbl(Me.Qtd.Text) * CDbl(Me.ValorUnitario.Text) + CDbl(Me.ValorFreteProduto.Text) + CDbl(Me.vSeg.Text) + CDbl(Me.vOutro.Text) - CDbl(Me.ValorDesconto.Text)) '  teste soma
    End Sub
End Class