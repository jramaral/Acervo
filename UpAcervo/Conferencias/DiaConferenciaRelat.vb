Public Class DiaConferenciaRelat
    ...
    Private Sub btVisualizar_Click(sender As Object, e As EventArgs) Handles btVisualizar.Click
        ...
        VerRelat.Load(DirRelat & "LancamentoDiaConferencia.rpt")
        ...
        SelectFormula = "{LancamentoBanco.DataLancamento} = Date (" & Format(CDate(Me.DataInicial.Text), "yyyy,MM,dd") & ") and {LancamentoBanco.Empresa} = " & CodEmpresa
