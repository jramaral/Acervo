Public Class CompraDiaConferenciaRelat
    ...
    Private Sub btVisualizar_Click(sender As Object, e As EventArgs) Handles btVisualizar.Click
        ...
        VerRelat.Load(DirRelat & "CompraLancamentosPeriodo.rpt")
        ...
        T.Text = "Conferência de Entradas do Dia: " & Me.DataInicial.Text

        Dim SelectFormula As String
        SelectFormula = "{Compra.DataLançamento} = Date(" & Format(CDate(Me.DataInicial.Text), "yyyy,MM,dd") & ") and {Compra.Inativo} = False and {Compra.Confirmado} = True and {Compra.Empresa} = " & CodEmpresa
